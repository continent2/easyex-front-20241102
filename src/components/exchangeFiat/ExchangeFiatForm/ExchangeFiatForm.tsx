...
export default function ExchangeFiatForm() {
  return (
    <div className="cont_box_wrp">
      <form>
        <div className="cont_box flexBox area02 ver_noList m-column">
          ...
          <div className="inp_tit">
            <h3>From</h3>
            <div className="money_inp in_alert ver_bg">
              <i className="won"></i>
        ...
        <div className="cont_box flexBox area02 ver_noList m-column">
          <div className="inp_txt">
            <h3>입금하시는 계좌 </h3>
            <div className="money_inp in_alert ver_textarea">
              <textarea name="" id="" className="inp_style" rows={2}>
